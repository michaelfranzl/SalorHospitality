class SetLimitations < ActiveRecord::Migration
  def up
    Vendor.update_all :max_tables => 10, :max_rooms => 5, :max_articles => 50, :max_options => 5, :max_users => 3, :max_categories => 6, :max_discounts => 3
    ...
    change_column :vendors, :max_discounts, :integer, :default => 3
  end
