  ...
  def generate_js_database(categories)
    ...
    categories.collect{ |cat|
      ...
      cat.articles.find_in_menucard.collect{ |art|
        ...
        "<tr><td id='article_#{ art.id }' class='article' onclick='#{ action }' onmousedown='articles_onmousedown(this)' onmouseup='articles_onmouseup(this)'>#{ Helper.escape_javascript art.name } #{ Helper.escape_javascript image }</td></tr>"
      }.to_s + '";'
    }.to_s
